...
window.PRODUCTS = [
  {
    ...
    name: '테이프커팅식',
    desc: '준공식·개소식 등 공식 행사에 맞춘 테이프커팅 세트 일체를 대여합니다.',
  },
  {
    id: 'gov-unveiling',
    category: 'category-gov',
    name: '제막식',
    desc: '기념비·현판 제막 행사에 필요한 막과 구조물을 격식에 맞게 준비합니다.',
  },
  {
    id: 'gov-podium',
    category: 'category-gov',
    name: '아크릴단상',
    desc: '공식 행사장에 어울리는 아크릴 단상으로 깔끔한 진행 무대를 만듭니다.',
  },
  {
    id: 'gov-banner',
    category: 'category-gov',
    name: '배너·안내판',
    desc: '행사 안내와 동선 정리를 위한 배너와 안내판을 제작·설치합니다.',
  },
  {
    id: 'festival-truss-arch',
    category: 'category-festival',
    name: '트러스 입구아치',
    desc: '행사장 입구를 알리는 트러스 아치로 첫인상을 확실하게 세웁니다.',
  },
  {
    id: 'festival-flower-deco',
    category: 'category-festival',
    name: '무대앞 조화장식',
    desc: '무대 앞을 화사하게 채우는 조화 장식으로 현장 분위기를 살립니다.',
  },
  {
    id: 'festival-photozone',
    category: 'category-festival',
    name: '포토존장식품',
    desc: '방문객이 머물고 싶은 포토존을 소품과 장식으로 완성합니다.',
  },
  {
    id: 'festival-effect',
    category: 'category-festival',
  ...
  {
    id: 'newyear-christmas',
    category: 'category-newyear',
    name: '크리스마스 장식',
    desc: '연말 분위기를 살리는 크리스마스 장식으로 행사장을 꾸밉니다.',
  },
  {
    id: 'newyear-bulb',
    category: 'category-newyear',
    name: '알전구',
    desc: '따뜻한 조명의 알전구 장식으로 신년회 분위기를 은은하게 연출합니다.',
  },
  {
    id: 'newyear-catering',
    category: 'category-newyear',
    name: '다과세팅',
    desc: '신년회 자리에 어울리는 다과 테이블 세팅을 구성해드립니다.',
  },
  {
    id: 'newyear-camping',
    category: 'category-newyear',
    name: '캠핑·빈백',
    desc: '편안한 좌석이 필요한 자리를 위한 캠핑 체어·빈백을 대여합니다.',
  },
  ...
  { id: 'rp-catering', category: 'rental', name: '다과세팅', desc: '행사 자리에 어울리는 다과 테이블 세팅을 구성합니다.' },
  ...
  { id: 'rp-stage-flower', category: 'rental', name: '무대앞 조화장식', desc: '무대 앞쪽을 화사하게 채우는 조화 장식입니다.' },
  { id: 'rp-mini-truss', category: 'rental', name: '미니트러스', desc: '소규모 공간에 어울리는 미니 트러스 구조물입니다.' },
  { id: 'rp-banner-sign', category: 'rental', name: '배너·안내판', desc: '행사 안내와 동선 정리를 위한 배너·안내판입니다.' },
  { id: 'rp-centerpiece', category: 'rental', name: '센터피스', desc: '테이블을 화사하게 꾸미는 센터피스 장식입니다.' },
  { id: 'rp-acrylic-podium', category: 'rental', name: '아크릴단상', desc: '깔끔한 진행 무대를 만드는 아크릴 단상입니다.' },
  { id: 'rp-bulb-light', category: 'rental', name: '알전구', desc: '은은한 분위기를 더하는 알전구 장식입니다.' },
  ...
  { id: 'rp-unveiling', category: 'rental', name: '제막식', desc: '기념비·현판 제막 행사에 필요한 막과 구조물입니다.' },
  { id: 'rp-photozone-instant', category: 'rental', name: '포토존 즉석인화', desc: '현장에서 바로 인화해주는 포토존 장비입니다.' },
  { id: 'rp-photozone-deco', category: 'rental', name: '포토존장식품', desc: '포토존을 완성하는 다양한 장식 소품입니다.' },
  ...
  { id: 'rp-camping-sofa', category: 'rental', name: '캠핑·빈백', desc: '편안한 좌석이 필요한 자리를 위한 캠핑 체어·빈백입니다.' },
  { id: 'rp-cube-scasi', category: 'rental', name: '큐브 스카시', desc: '전시·진열에 활용하는 큐브 스카시 구조물입니다.' },
  { id: 'rp-christmas-deco', category: 'rental', name: '크리스마스 장식', desc: '연말 분위기를 살리는 크리스마스 장식입니다.' },
  { id: 'rp-dressing-room', category: 'rental', name: '탈의실', desc: '행사장에 설치하는 간이 탈의실을 대여합니다.' },
  { id: 'rp-tape-cutting', category: 'rental', name: '테이프커팅식', desc: '준공식·개소식에 맞춘 테이프커팅 세트 일체입니다.' },
  { id: 'rp-truss-arch', category: 'rental', name: '트러스 입구아치', desc: '행사장 입구를 알리는 트러스 아치입니다.' },
